export const BRAND = {
  name: 'Shindeshahi Chinese Restro',
  fullName: 'Shindeshahi Chinese Restro – Satara',
  marathi: 'शिंदेशाही चायनीज रेस्टो - सातारा',
  chinese: '王家中餐',
  tagline: 'Taste That Wins Hearts',
  taglineMarathi: 'चव जो मन जिंके',
  phone: '+91 98604 67474',
  phoneAlt: '+91 83291 36583',
  address: 'M2P5+5MM, Kamathipura, Guruwar Peth, Satara, Maharashtra 415001',
  ...
  order: {
    ...
    whatsapp: 'https://wa.me/919860467474?text=Hi%20Shindeshahi%20Chinese%20Restro%2C%20I%27d%20like%20to%20place%20an%20order'
  },
  socials: {
    instagram: 'https://www.instagram.com/shindeshahi_chinese_resto/?hl=en',
    facebook: 'https://www.facebook.com/ShindeShahiChineseResto/',
    zomato: 'https://www.zomato.com/satara/shinde-shahi-chinese-restro-satara-locality',
    swiggy: 'https://www.swiggy.com/city/satara/shinde-shahi-chinese-restaurant-guruwar-peth-y-c-collage-rest143185'
  }
}
...
export const IMG = {
  logo: '/gallery/shindeshai_logo.jpg',
  shop: '/gallery/shindeshahi_shop.jpg',
  shop2: '/gallery/shindeshahishopimg2.jpg',
...
// Featured / signature dishes (real Shindeshahi Chinese Restro bestsellers)
export const FEATURED_DISHES = [
  { id: 'chicken-shindesh-rice', name: 'Chicken Shindeshahi Special Rice', marathi: 'चिकन शिंदेशाही स्पेशल राईस', price: 290, halfPrice: 150, category: 'Signature', tag: "Signature", image: IMG.schezwanRice, description: 'Our legendary house special — the dish that put Shindeshahi Chinese Restro on the map. Fragrant basmati wok-tossed with our secret masala, spring onions and chicken chunks.' },
  ...
  { id: 'shindesh-noodles', name: 'Chicken Shindeshahi Special Noodles', marathi: 'चिकन शिंदेशाही नूडल्स', price: 290, halfPrice: 150, category: 'Signature', tag: 'Signature', image: IMG.noodles1, description: 'Hakka noodles reimagined the Shindeshahi way — in our house gravy with chicken chunks, capsicum, and a hint of smoky wok magic.' },
...
// Full menu (from actual Shindeshahi menu card — all prices in ₹)
export const FULL_MENU = [
  ...
  { id: 'veg-shindesh-rice', name: 'Veg Shindeshahi Rice + Gravy', marathi: 'व्हेज शिंदेशाही राईस', price: 270, halfPrice: 140, category: 'Rice', tag: 'Signature', image: IMG.schezwanRice, description: 'Vegetarian version of our house signature — full-flavour, family-size.' },
...
// Real Google reviews from Shindeshahi Chinese Restro
export const REVIEWS = [
  { name: 'Samindra Art', role: 'Google Review · 6 months ago', text: 'Shindeshahi Chinese Restro offers a fantastic ambiance and top notch service at a very pocket friendly price. The Manchow soup, Chicken Dinosaur Rice are absolute must tries — flavorful, fresh, and uniquely tasty.', rating: 5, initials: 'SA' },
  { name: 'Kisan Rathod', role: 'Local Guide · 99 reviews', text: 'Shindeshahi is one of the best Chinese resto in Satara. Food is delicious and very tasty. Quantity is also sufficient in every order. An unforgettable dining experience that delights the palate.', rating: 5, initials: 'KR' },
  ...
  { name: 'Sumit Kadam', role: 'Google Review', text: 'My family and I had a wonderful experience. We ordered Chicken Shindeshahi Special, Drumstick, and Chicken Manchow Soup. The food was delicious, especially the Drumsticks with rich creamy sauce.', rating: 5, initials: 'SK' },
...
export const WHY_US = [
  ...
  { title: 'The Shindeshahi Signature', marathi: 'स्पेशल रेसिपी', desc: 'A house-secret masala perfected over years — in our Dinosaur Rice, Special Noodles and legendary Chicken Lollipop.', icon: 'flame' },

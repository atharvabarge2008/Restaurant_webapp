export const BRAND = {
  name: 'Shindesh',
  fullName: 'Shindesh Chinese Restaurant - Satara',
  ...
  order: {
    ...
    whatsapp: 'https://wa.me/919860467474?text=Hi%20Shindesh%2C%20I%27d%20like%20to%20place%20an%20order'
  },
  socials: {
...
// Featured / signature dishes (real Shindesh bestsellers)
export const FEATURED_DISHES = [
  { id: 'chicken-shindesh-rice', name: 'Chicken Shindesh Special Rice', marathi: 'चिकन शिंदेश स्पेशल राईस', price: 290, halfPrice: 150, category: 'Signature', tag: "Signature", image: IMG.schezwanRice, description: 'Our legendary house special — the dish that put Shindesh on the map. Fragrant basmati wok-tossed with our secret masala, spring onions and chicken chunks.' },
  ...
  { id: 'shindesh-noodles', name: 'Chicken Shindesh Special Noodles', marathi: 'चिकन शिंदेश नूडल्स', price: 290, halfPrice: 150, category: 'Signature', tag: 'Signature', image: IMG.noodles1, description: 'Hakka noodles reimagined the Shindesh way — in our house gravy with chicken chunks, capsicum, and a hint of smoky wok magic.' },
...
// Full menu (from actual Shindesh menu card — all prices in ₹)
export const FULL_MENU = [
  ...
  { id: 'veg-shindesh-rice', name: 'Veg Shindesh Rice + Gravy', marathi: 'व्हेज शिंदेश राईस', price: 270, halfPrice: 140, category: 'Rice', tag: 'Signature', image: IMG.schezwanRice, description: 'Vegetarian version of our house signature — full-flavour, family-size.' },
...
// Real Google reviews from Shindesh Chinese Resto
export const REVIEWS = [
  { name: 'Samindra Art', role: 'Google Review · 6 months ago', text: 'Shindesh Chinese Resto offers a fantastic ambiance and top notch service at a very pocket friendly price. The Manchow soup, Chicken Dinosaur Rice are absolute must tries — flavorful, fresh, and uniquely tasty.', rating: 5, initials: 'SA' },
  { name: 'Kisan Rathod', role: 'Local Guide · 99 reviews', text: 'Shindesh is one of the best Chinese resto in Satara. Food is delicious and very tasty. Quantity is also sufficient in every order. An unforgettable dining experience that delights the palate.', rating: 5, initials: 'KR' },
  ...
  { name: 'Sumit Kadam', role: 'Google Review', text: 'My family and I had a wonderful experience. We ordered Chicken Shindesh Special, Drumstick, and Chicken Manchow Soup. The food was delicious, especially the Drumsticks with rich creamy sauce.', rating: 5, initials: 'SK' },
...
export const WHY_US = [
  ...
  { title: 'The Shindesh Signature', marathi: 'स्पेशल रेसिपी', desc: 'A house-secret masala perfected over years — in our Dinosaur Rice, Special Noodles and legendary Chicken Lollipop.', icon: 'flame' },

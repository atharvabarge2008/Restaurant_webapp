export const BRAND = {
  ...
  order: {
    ...
    swiggy: 'https://www.swiggy.com/restaurants/shinde-shahi-chinese-restaurant-y-c-collage-satara-satara-813737',
    call: 'tel:+919860467474',
    whatsapp: 'https://wa.me/919860467474?text=Hi%20ShindeShahi%2C%20I%27d%20like%20to%20place%20an%20order'
  },
  socials: {
    instagram: 'https://instagram.com/shindeshahi_chinese_resto',
    facebook: 'https://facebook.com/ShindeShahiChineseResto',
    zomato: 'https://www.zomato.com/satara/shinde-shahi-chinese-restro-satara-locality',
    swiggy: 'https://www.swiggy.com/restaurants/shinde-shahi-chinese-restaurant-y-c-collage-satara-satara-813737'
  }
}
...
// Featured / signature dishes (real ShindeShahi bestsellers)
export const FEATURED_DISHES = [
  { id: 'chicken-shindeshahi-rice', name: 'Chicken ShindeShahi Special Rice', marathi: 'चिकन शिंदेशाही स्पेशल राईस', price: 290, halfPrice: 150, category: 'Signature', tag: "Signature", image: IMG.schezwanRice, description: 'Our legendary house special — the dish that put ShindeShahi on the map. Fragrant basmati wok-tossed with our secret masala, spring onions and chicken chunks.' },
  ...
  { id: 'shindeshahi-noodles', name: 'Chicken ShindeShahi Special Noodles', marathi: 'चिकन शिंदेशाही नूडल्स', price: 290, halfPrice: 150, category: 'Signature', tag: 'Signature', image: IMG.noodles1, description: 'Hakka noodles reimagined the ShindeShahi way — in our house gravy with chicken chunks, capsicum, and a hint of smoky wok magic.' },
...
export const FULL_MENU = [
  ...
  { id: 'veg-shindeshahi-rice', name: 'Veg ShindeShahi Rice + Gravy', marathi: 'व्हेज शिंदेशाही राईस', price: 270, halfPrice: 140, category: 'Rice', tag: 'Signature', image: IMG.schezwanRice, description: 'Vegetarian version of our house signature — full-flavour, family-size.' },
...
// Real Google reviews from ShindeShahi Chinese Resto
export const REVIEWS = [
  { name: 'Samindra Art', role: 'Google Review · 6 months ago', text: 'ShindeShahi Chinese Resto offers a fantastic ambiance and top notch service at a very pocket friendly price. The Manchow soup, Chicken Dinosaur Rice are absolute must tries — flavorful, fresh, and uniquely tasty.', rating: 5, initials: 'SA' },

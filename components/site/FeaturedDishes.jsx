  ...
  return (
    <section id="featured" className="relative py-24 md:py-32 bg-brand-ink overflow-hidden">
      ...
      <div className="relative container mx-auto px-6">
        <SectionHeading eyebrow="Featured Menu" title="Bestsellers that made Shindeshahi famous" subtitle="The dishes locals travel across Satara for — handcrafted with our house-secret masala." />
